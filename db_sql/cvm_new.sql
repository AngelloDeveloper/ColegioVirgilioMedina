...
-- Volcando datos para la tabla cvm.cupos: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `paises` (
  ...
  `name` varchar(30) NOT NULL COMMENT 'Nombre descritivo',
  `iso_name` varchar(30) NOT NULL COMMENT 'Nombre standard ISO',
  `alfa2` varchar(2) NOT NULL COMMENT 'Código de 2 caracteres',
  `alfa3` varchar(3) NOT NULL COMMENT 'Código de 3 caracteres',
  `numerico` int(3) NOT NULL COMMENT 'Código único por país',
  `zona` enum('LATAM','WORLD') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=250 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='Lista de paises con códigos ISO, fuente http://es.wikipedia.org/wiki/ISO_3166-1';

-- Volcando datos para la tabla cvm.paises: ~249 rows (aproximadamente)
INSERT INTO `paises` (`id`, `name`, `iso_name`, `alfa2`, `alfa3`, `numerico`, `zona`) VALUES
	(1, ' Afganistán', 'Afganistán', 'AF', 'AFG', 4, NULL),
	(2, ' Åland', 'Islas Åland', 'AX', 'ALA', 248, NULL),
	(3, ' Albania', 'Albania', 'AL', 'ALB', 8, NULL),
	(4, ' Alemania', 'Alemania', 'DE', 'DEU', 276, NULL),
	(5, ' Andorra', 'Andorra', 'AD', 'AND', 20, NULL),
	(6, ' Angola', 'Angola', 'AO', 'AGO', 24, NULL),
	(7, ' Anguila', 'Anguila', 'AI', 'AIA', 660, NULL),
	(8, ' Antártida', 'Antártida', 'AQ', 'ATA', 10, NULL),
	(9, ' Antigua y Barbuda', 'Antigua y Barbuda', 'AG', 'ATG', 28, NULL),
	(10, ' Arabia Saudita', 'Arabia Saudita', 'SA', 'SAU', 682, NULL),
	(11, ' Argelia', 'Argelia', 'DZ', 'DZA', 12, NULL),
	(12, ' Argentina', 'Argentina', 'AR', 'ARG', 32, 'LATAM'),
	(13, ' Armenia', 'Armenia', 'AM', 'ARM', 51, NULL),
	(14, ' Aruba', 'Aruba', 'AW', 'ABW', 533, NULL),
	(15, ' Australia', 'Australia', 'AU', 'AUS', 36, NULL),
	(16, ' Austria', 'Austria', 'AT', 'AUT', 40, NULL),
	(17, ' Azerbaiyán', 'Azerbaiyán', 'AZ', 'AZE', 31, NULL),
	(18, ' Bahamas', 'Bahamas (las)', 'BS', 'BHS', 44, NULL),
	(19, ' Bangladés', 'Bangladés', 'BD', 'BGD', 50, NULL),
	(20, ' Barbados', 'Barbados', 'BB', 'BRB', 52, NULL),
	(21, ' Baréin', 'Baréin', 'BH', 'BHR', 48, NULL),
	(22, ' Bélgica', 'Bélgica', 'BE', 'BEL', 56, NULL),
	(23, ' Belice', 'Belice', 'BZ', 'BLZ', 84, 'LATAM'),
	(24, ' Benín', 'Benín', 'BJ', 'BEN', 204, NULL),
	(25, ' Bermudas', 'Bermudas', 'BM', 'BMU', 60, NULL),
	(26, ' Bielorrusia', 'Bielorrusia', 'BY', 'BLR', 112, NULL),
	(27, ' Birmania', 'Myanmar', 'MM', 'MMR', 104, NULL),
	(28, ' Bolivia', 'Bolivia, Estado Plurinacional ', 'BO', 'BOL', 68, 'LATAM'),
	(29, ' Bosnia y Herzegovina', 'Bosnia y Herzegovina', 'BA', 'BIH', 70, NULL),
	(30, ' Botsuana', 'Botsuana', 'BW', 'BWA', 72, NULL),
	(31, ' Brasil', 'Brasil', 'BR', 'BRA', 76, 'LATAM'),
	(32, ' Brunéi', 'Brunéi Darussalam', 'BN', 'BRN', 96, NULL),
	(33, ' Bulgaria', 'Bulgaria', 'BG', 'BGR', 100, NULL),
	(34, ' Burkina Faso', 'Burkina Faso', 'BF', 'BFA', 854, NULL),
	(35, ' Burundi', 'Burundi', 'BI', 'BDI', 108, NULL),
	(36, ' Bután', 'Bután', 'BT', 'BTN', 64, NULL),
	(37, ' Cabo Verde', 'Cabo Verde', 'CV', 'CPV', 132, NULL),
	(38, ' Camboya', 'Camboya', 'KH', 'KHM', 116, NULL),
	(39, ' Camerún', 'Camerún', 'CM', 'CMR', 120, NULL),
	(40, ' Canadá', 'Canadá', 'CA', 'CAN', 124, NULL),
	(41, ' Catar', 'Catar', 'QA', 'QAT', 634, NULL),
	(42, ' Caribe Neerlandés', 'Bonaire, San Eustaquio y Saba', 'BQ', 'BES', 535, NULL),
	(43, ' Chad', 'Chad', 'TD', 'TCD', 148, NULL),
	(44, ' Chile', 'Chile', 'CL', 'CHL', 152, 'LATAM'),
	(45, ' China', 'China', 'CN', 'CHN', 156, NULL),
	(46, ' Chipre', 'Chipre', 'CY', 'CYP', 196, NULL),
	(47, ' Colombia', 'Colombia', 'CO', 'COL', 170, 'LATAM'),
	(48, ' Comoras', 'Comoras', 'KM', 'COM', 174, NULL),
	(49, ' Corea del Norte', 'Corea (la República Democrátic', 'KP', 'PRK', 408, NULL),
	(50, ' Corea del Sur', 'Corea (la República de)', 'KR', 'KOR', 410, NULL),
	(51, ' Costa de Marfil', 'Côte d\'Ivoire', 'CI', 'CIV', 384, NULL),
	(52, ' Costa Rica', 'Costa Rica', 'CR', 'CRI', 188, 'LATAM'),
	(53, ' Croacia', 'Croacia', 'HR', 'HRV', 191, NULL),
	(54, ' Cuba', 'Cuba', 'CU', 'CUB', 192, 'LATAM'),
	(55, ' Curazao', 'Curaçao', 'CW', 'CUW', 531, NULL),
	(56, ' Dinamarca', 'Dinamarca', 'DK', 'DNK', 208, NULL),
	(57, ' Dominica', 'Dominica', 'DM', 'DMA', 212, NULL),
	(58, ' Ecuador', 'Ecuador', 'EC', 'ECU', 218, 'LATAM'),
	(59, ' Egipto', 'Egipto', 'EG', 'EGY', 818, NULL),
	(60, ' El Salvador', 'El Salvador', 'SV', 'SLV', 222, 'LATAM'),
	(61, ' Emiratos Árabes Unidos', 'Emiratos Árabes Unidos (Los)', 'AE', 'ARE', 784, NULL),
	(62, ' Eritrea', 'Eritrea', 'ER', 'ERI', 232, NULL),
	(63, ' Eslovaquia', 'Eslovaquia', 'SK', 'SVK', 703, NULL),
	(64, ' Eslovenia', 'Eslovenia', 'SI', 'SVN', 705, NULL),
	(65, ' España', 'España', 'ES', 'ESP', 724, NULL),
	(66, ' Estados Unidos', 'Estados Unidos (los)', 'US', 'USA', 840, NULL),
	(67, ' Estonia', 'Estonia', 'EE', 'EST', 233, NULL),
	(68, ' Etiopía', 'Etiopía', 'ET', 'ETH', 231, NULL),
	(69, ' Filipinas', 'Filipinas (las)', 'PH', 'PHL', 608, NULL),
	(70, ' Finlandia', 'Finlandia', 'FI', 'FIN', 246, NULL),
	(71, ' Fiyi', 'Fiyi', 'FJ', 'FJI', 242, NULL),
	(72, ' Francia', 'Francia', 'FR', 'FRA', 250, NULL),
	(73, ' Gabón', 'Gabón', 'GA', 'GAB', 266, NULL),
	(74, ' Gambia', 'Gambia (La)', 'GM', 'GMB', 270, NULL),
	(75, ' Georgia', 'Georgia', 'GE', 'GEO', 268, NULL),
	(76, ' Ghana', 'Ghana', 'GH', 'GHA', 288, NULL),
	(77, ' Gibraltar', 'Gibraltar', 'GI', 'GIB', 292, NULL),
	(78, ' Granada', 'Granada', 'GD', 'GRD', 308, NULL),
	(79, ' Grecia', 'Grecia', 'GR', 'GRC', 300, NULL),
	(80, ' Groenlandia', 'Groenlandia', 'GL', 'GRL', 304, NULL),
	(81, ' Guadalupe', 'Guadalupe', 'GP', 'GLP', 312, NULL),
	(82, ' Guam', 'Guam', 'GU', 'GUM', 316, NULL),
	(83, ' Guatemala', 'Guatemala', 'GT', 'GTM', 320, 'LATAM'),
	(84, ' Guayana Francesa', 'Guayana Francesa', 'GF', 'GUF', 254, NULL),
	(85, ' Guernsey', 'Guernsey', 'GG', 'GGY', 831, NULL),
	(86, ' Guinea', 'Guinea', 'GN', 'GIN', 324, NULL),
	(87, ' Guinea-Bisáu', 'Guinea-Bisáu', 'GW', 'GNB', 624, NULL),
	(88, ' Guinea Ecuatorial', 'Guinea Ecuatorial', 'GQ', 'GNQ', 226, NULL),
	(89, ' Guyana', 'Guyana', 'GY', 'GUY', 328, 'LATAM'),
	(90, ' Haití', 'Haití', 'HT', 'HTI', 332, 'LATAM'),
	(91, ' Honduras', 'Honduras', 'HN', 'HND', 340, 'LATAM'),
	(92, ' Hong Kong', 'Hong Kong', 'HK', 'HKG', 344, NULL),
	(93, ' Hungría', 'Hungría', 'HU', 'HUN', 348, NULL),
	(94, ' India', 'India', 'IN', 'IND', 356, NULL),
	(95, ' Indonesia', 'Indonesia', 'ID', 'IDN', 360, NULL),
	(96, ' Irak', 'Irak', 'IQ', 'IRQ', 368, NULL),
	(97, ' Irán', 'Irán (la República Islámica de', 'IR', 'IRN', 364, NULL),
	(98, ' Irlanda', 'Irlanda', 'IE', 'IRL', 372, NULL),
	(99, ' Isla Bouvet', 'Isla Bouvet', 'BV', 'BVT', 74, NULL),
	(100, ' Isla de Man', 'Isla de Man', 'IM', 'IMN', 833, NULL),
	(101, ' Isla de Navidad', 'Isla de Navidad', 'CX', 'CXR', 162, NULL),
	(102, ' Norfolk', 'Isla Norfolk', 'NF', 'NFK', 574, NULL),
	(103, ' Islandia', 'Islandia', 'IS', 'ISL', 352, NULL),
	(104, ' Islas Caimán', 'Islas Caimán (las)', 'KY', 'CYM', 136, NULL),
	(105, ' Islas Cocos', 'Islas Cocos (Keeling)', 'CC', 'CCK', 166, NULL),
	(106, ' Islas Cook', 'Islas Cook (las)', 'CK', 'COK', 184, NULL),
	(107, ' Islas Feroe', 'Islas Feroe (las)', 'FO', 'FRO', 234, NULL),
	(108, ' Islas Georgias del Sur y Sand', 'Georgia del sur y las islas sa', 'GS', 'SGS', 239, NULL),
	(109, ' Islas Heard y McDonald', 'Isla Heard e Islas McDonald', 'HM', 'HMD', 334, NULL),
	(110, ' Islas Malvinas', 'Islas Malvinas [Falkland] (las', 'FK', 'FLK', 238, NULL),
	(111, ' Islas Marianas del Norte', 'Islas Marianas del Norte (las)', 'MP', 'MNP', 580, NULL),
	(112, ' Islas Marshall', 'Islas Marshall (las)', 'MH', 'MHL', 584, NULL),
	(113, ' Islas Pitcairn', 'Pitcairn', 'PN', 'PCN', 612, NULL),
	(114, ' Islas Salomón', 'Islas Salomón (las)', 'SB', 'SLB', 90, NULL),
	(115, ' Islas Turcas y Caicos', 'Islas Turcas y Caicos (las)', 'TC', 'TCA', 796, NULL),
	(116, ' Islas ultramarinas de Estados', 'Islas de Ultramar Menores de E', 'UM', 'UMI', 581, NULL),
	(117, ' Islas Vírgenes Británicas', 'Islas Vírgenes (Británicas)', 'VG', 'VGB', 92, NULL),
	(118, ' Islas Vírgenes de los Estados', 'Islas Vírgenes (EE.UU.)', 'VI', 'VIR', 850, NULL),
	(119, ' Israel', 'Israel', 'IL', 'ISR', 376, NULL),
	(120, ' Italia', 'Italia', 'IT', 'ITA', 380, NULL),
	(121, ' Jamaica', 'Jamaica', 'JM', 'JAM', 388, NULL),
	(122, ' Japón', 'Japón', 'JP', 'JPN', 392, NULL),
	(123, ' Jersey', 'Jersey', 'JE', 'JEY', 832, NULL),
	(124, ' Jordania', 'Jordania', 'JO', 'JOR', 400, NULL),
	(125, ' Kazajistán', 'Kazajistán', 'KZ', 'KAZ', 398, NULL),
	(126, ' Kenia', 'Kenia', 'KE', 'KEN', 404, NULL),
	(127, ' Kirguistán', 'Kirguistán', 'KG', 'KGZ', 417, NULL),
	(128, ' Kiribati', 'Kiribati', 'KI', 'KIR', 296, NULL),
	(129, ' Kuwait', 'Kuwait', 'KW', 'KWT', 414, NULL),
	(130, ' Laos', 'Lao, (la) República Democrátic', 'LA', 'LAO', 418, NULL),
	(131, ' Lesoto', 'Lesoto', 'LS', 'LSO', 426, NULL),
	(132, ' Letonia', 'Letonia', 'LV', 'LVA', 428, NULL),
	(133, ' Líbano', 'Líbano', 'LB', 'LBN', 422, NULL),
	(134, ' Liberia', 'Liberia', 'LR', 'LBR', 430, NULL),
	(135, ' Libia', 'Libia', 'LY', 'LBY', 434, NULL),
	(136, ' Liechtenstein', 'Liechtenstein', 'LI', 'LIE', 438, NULL),
	(137, ' Lituania', 'Lituania', 'LT', 'LTU', 440, NULL),
	(138, ' Luxemburgo', 'Luxemburgo', 'LU', 'LUX', 442, NULL),
	(139, ' Macao', 'Macao', 'MO', 'MAC', 446, NULL),
	(140, ' Madagascar', 'Madagascar', 'MG', 'MDG', 450, NULL),
	(141, ' Malasia', 'Malasia', 'MY', 'MYS', 458, NULL),
	(142, ' Malaui', 'Malaui', 'MW', 'MWI', 454, NULL),
	(143, ' Maldivas', 'Maldivas', 'MV', 'MDV', 462, NULL),
	(144, ' Malí', 'Malí', 'ML', 'MLI', 466, NULL),
	(145, ' Malta', 'Malta', 'MT', 'MLT', 470, NULL),
	(146, ' Marruecos', 'Marruecos', 'MA', 'MAR', 504, NULL),
	(147, ' Martinica', 'Martinica', 'MQ', 'MTQ', 474, NULL),
	(148, ' Mauricio', 'Mauricio', 'MU', 'MUS', 480, NULL),
	(149, ' Mauritania', 'Mauritania', 'MR', 'MRT', 478, NULL),
	(150, ' Mayotte', 'Mayotte', 'YT', 'MYT', 175, NULL),
	(151, ' México', 'México', 'MX', 'MEX', 484, NULL),
	(152, ' Micronesia', 'Micronesia (los Estados Federa', 'FM', 'FSM', 583, NULL),
	(153, ' Moldavia', 'Moldavia (la República de)', 'MD', 'MDA', 498, NULL),
	(154, ' Mónaco', 'Mónaco', 'MC', 'MCO', 492, NULL),
	(155, ' Mongolia', 'Mongolia', 'MN', 'MNG', 496, NULL),
	(156, ' Montenegro', 'Montenegro', 'ME', 'MNE', 499, NULL),
	(157, ' Montserrat', 'Montserrat', 'MS', 'MSR', 500, NULL),
	(158, ' Mozambique', 'Mozambique', 'MZ', 'MOZ', 508, NULL),
	(159, ' Namibia', 'Namibia', 'NA', 'NAM', 516, NULL),
	(160, ' Nauru', 'Nauru', 'NR', 'NRU', 520, NULL),
	(161, ' Nepal', 'Nepal', 'NP', 'NPL', 524, NULL),
	(162, ' Nicaragua', 'Nicaragua', 'NI', 'NIC', 558, 'LATAM'),
	(163, ' Níger', 'Níger (el)', 'NE', 'NER', 562, NULL),
	(164, ' Nigeria', 'Nigeria', 'NG', 'NGA', 566, NULL),
	(165, ' Niue', 'Niue', 'NU', 'NIU', 570, NULL),
	(166, ' Noruega', 'Noruega', 'NO', 'NOR', 578, NULL),
	(167, ' Nueva Caledonia', 'Nueva Caledonia', 'NC', 'NCL', 540, NULL),
	(168, ' Nueva Zelanda', 'Nueva Zelanda', 'NZ', 'NZL', 554, NULL),
	(169, ' Omán', 'Omán', 'OM', 'OMN', 512, NULL),
	(170, ' Países Bajos', 'Países Bajos (los)', 'NL', 'NLD', 528, NULL),
	(171, ' Pakistán', 'Pakistán', 'PK', 'PAK', 586, NULL),
	(172, ' Palaos', 'Palaos', 'PW', 'PLW', 585, NULL),
	(173, ' Palestina', 'Palestina, Estado de', 'PS', 'PSE', 275, NULL),
	(174, ' Panamá', 'Panamá', 'PA', 'PAN', 591, 'LATAM'),
	(175, ' Papúa Nueva Guinea', 'Papúa Nueva Guinea', 'PG', 'PNG', 598, NULL),
	(176, ' Paraguay', 'Paraguay', 'PY', 'PRY', 600, 'LATAM'),
	(177, ' Perú', 'Perú', 'PE', 'PER', 604, 'LATAM'),
	(178, ' Polinesia Francesa', 'Polinesia Francesa', 'PF', 'PYF', 258, NULL),
	(179, ' Polonia', 'Polonia', 'PL', 'POL', 616, NULL),
	(180, ' Portugal', 'Portugal', 'PT', 'PRT', 620, NULL),
	(181, ' Puerto Rico', 'Puerto Rico', 'PR', 'PRI', 630, NULL),
	(182, ' Reino Unido', 'Reino Unido (el)', 'GB', 'GBR', 826, NULL),
	(183, ' República Centroafricana', 'República Centroafricana (la)', 'CF', 'CAF', 140, NULL),
	(184, ' República Checa', 'República Checa (la)', 'CZ', 'CZE', 203, NULL),
	(185, ' Macedonia', 'Macedonia (la antigua Repúblic', 'MK', 'MKD', 807, NULL),
	(186, ' República del Congo', 'Congo', 'CG', 'COG', 178, NULL),
	(187, ' República Democrática del Con', 'Congo (la República Democrátic', 'CD', 'COD', 180, NULL),
	(188, ' República Dominicana', 'República Dominicana (la)', 'DO', 'DOM', 214, 'LATAM'),
	(189, ' Reunión', 'Reunión', 'RE', 'REU', 638, NULL),
	(190, ' Ruanda', 'Ruanda', 'RW', 'RWA', 646, NULL),
	(191, ' Rumania', 'Rumania', 'RO', 'ROU', 642, NULL),
	(192, ' Rusia', 'Rusia, (la) Federación de', 'RU', 'RUS', 643, NULL),
	(193, ' República Árabe Saharaui Demo', 'Sahara Occidental', 'EH', 'ESH', 732, NULL),
	(194, ' Samoa', 'Samoa', 'WS', 'WSM', 882, NULL),
	(195, ' Samoa Americana', 'Samoa Americana', 'AS', 'ASM', 16, NULL),
	(196, ' San Bartolomé', 'San Bartolomé', 'BL', 'BLM', 652, NULL),
	(197, ' San Cristóbal y Nieves', 'San Cristóbal y Nieves', 'KN', 'KNA', 659, NULL),
	(198, ' San Marino', 'San Marino', 'SM', 'SMR', 674, NULL),
	(199, ' San Martín', 'San Martín (parte francesa)', 'MF', 'MAF', 663, NULL),
	(200, ' San Pedro y Miquelón', 'San Pedro y Miquelón', 'PM', 'SPM', 666, NULL),
	(201, ' San Vicente y las Granadinas', 'San Vicente y las Granadinas', 'VC', 'VCT', 670, NULL),
	(202, ' Santa Elena, Ascensión y Tris', 'Santa Helena, Ascensión y Tris', 'SH', 'SHN', 654, NULL),
	(203, ' Santa Lucía', 'Santa Lucía', 'LC', 'LCA', 662, NULL),
	(204, ' Santo Tomé y Príncipe', 'Santo Tomé y Príncipe', 'ST', 'STP', 678, NULL),
	(205, ' Senegal', 'Senegal', 'SN', 'SEN', 686, NULL),
	(206, ' Serbia', 'Serbia', 'RS', 'SRB', 688, NULL),
	(207, ' Seychelles', 'Seychelles', 'SC', 'SYC', 690, NULL),
	(208, ' Sierra Leona', 'Sierra leona', 'SL', 'SLE', 694, NULL),
	(209, ' Singapur', 'Singapur', 'SG', 'SGP', 702, NULL),
	(210, ' Sint Maarten', 'Sint Maarten (parte holandesa)', 'SX', 'SXM', 534, NULL),
	(211, ' Siria', 'Siria, (la) República Árabe', 'SY', 'SYR', 760, NULL),
	(212, ' Somalia', 'Somalia', 'SO', 'SOM', 706, NULL),
	(213, ' Sri Lanka', 'Sri Lanka', 'LK', 'LKA', 144, NULL),
	(214, ' Suazilandia', 'Suazilandia', 'SZ', 'SWZ', 748, NULL),
	(215, ' Sudáfrica', 'Sudáfrica', 'ZA', 'ZAF', 710, NULL),
	(216, ' Sudán', 'Sudán (el)', 'SD', 'SDN', 729, NULL),
	(217, ' Sudán del Sur', 'Sudán del Sur', 'SS', 'SSD', 728, NULL),
	(218, ' Suecia', 'Suecia', 'SE', 'SWE', 752, NULL),
	(219, '  Suiza', 'Suiza', 'CH', 'CHE', 756, NULL),
	(220, ' Surinam', 'Surinam', 'SR', 'SUR', 740, 'LATAM'),
	(221, ' Svalbard y Jan Mayen', 'Svalbard y Jan Mayen', 'SJ', 'SJM', 744, NULL),
	(222, ' Tailandia', 'Tailandia', 'TH', 'THA', 764, NULL),
	(223, ' República de China', 'Taiwán (Provincia de China)', 'TW', 'TWN', 158, NULL),
	(224, ' Tanzania', 'Tanzania, República Unida de', 'TZ', 'TZA', 834, NULL),
	(225, ' Tayikistán', 'Tayikistán', 'TJ', 'TJK', 762, NULL),
	(226, ' Territorio Británico del Océa', 'Territorio Británico del Océan', 'IO', 'IOT', 86, NULL),
	(227, ' Tierras Australes y Antártica', 'Territorios Australes Francese', 'TF', 'ATF', 260, NULL),
	(228, ' Timor Oriental', 'Timor-Leste', 'TL', 'TLS', 626, NULL),
	(229, ' Togo', 'Togo', 'TG', 'TGO', 768, NULL),
	(230, ' Tokelau', 'Tokelau', 'TK', 'TKL', 772, NULL),
	(231, ' Tonga', 'Tonga', 'TO', 'TON', 776, NULL),
	(232, ' Trinidad y Tobago', 'Trinidad y Tobago', 'TT', 'TTO', 780, NULL),
	(233, ' Túnez', 'Túnez', 'TN', 'TUN', 788, NULL),
	(234, ' Turkmenistán', 'Turkmenistán', 'TM', 'TKM', 795, NULL),
	(235, ' Turquía', 'Turquía', 'TR', 'TUR', 792, NULL),
	(236, ' Tuvalu', 'Tuvalu', 'TV', 'TUV', 798, NULL),
	(237, ' Ucrania', 'Ucrania', 'UA', 'UKR', 804, NULL),
	(238, ' Uganda', 'Uganda', 'UG', 'UGA', 800, NULL),
	(239, ' Uruguay', 'Uruguay', 'UY', 'URY', 858, 'LATAM'),
	(240, ' Uzbekistán', 'Uzbekistán', 'UZ', 'UZB', 860, NULL),
	(241, ' Vanuatu', 'Vanuatu', 'VU', 'VUT', 548, NULL),
	(242, ' Ciudad del Vaticano', 'Santa Sede [Estado de la Ciuda', 'VA', 'VAT', 336, NULL),
	(243, ' Venezuela', 'Venezuela, República Bolivaria', 'VE', 'VEN', 862, 'LATAM'),
	(244, ' Vietnam', 'Viet Nam', 'VN', 'VNM', 704, NULL),
	(245, ' Wallis y Futuna', 'Wallis y Futuna', 'WF', 'WLF', 876, NULL),
	(246, ' Yemen', 'Yemen', 'YE', 'YEM', 887, NULL),
	(247, ' Yibuti', 'Yibuti', 'DJ', 'DJI', 262, NULL),
	(248, ' Zambia', 'Zambia', 'ZM', 'ZMB', 894, NULL),
	(249, ' Zimbabue', 'Zimbabue', 'ZW', 'ZWE', 716, NULL);
