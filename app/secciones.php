                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button id="btNewSeccion" type="bu Agregar Seccióntton" class="btn btn-success mb-1" style="color: #fff; background-color: #00B236; float: right;">
                                   Nuevo
                                        ...
                                        <?php foreach($arrSecciones as $index => $seccion) { 
                                            ...
                                            foreach($arrSeccioneGrados as $grados) {
                                                if($grados['id_seccion'] == $seccion['id']) {
                                                    foreach($arrGrados as $indexs => $t_grados) {
                                                        if($t_grados['id'] == $grados['id_grado']) {
                                                            if($grados['turno'] == 'M') {
                                                                $arrTemp_m[$indexs] = $t_grados['formato'];
                                                                $tempGrados_M .= $t_grados['formato'];
                                                            }

                                                            if($grados['turno'] == 'T') {
                                                                $arrTemp_t[$indexs] = $t_grados['formato'];
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <button 
                                                                    ...
                                                                    data-section="<?= $seccion['seccion'] ?>" 
                                                                    data-turnm="<?= implode(',', $arrTemp_m) ?>"
                                                                    data-turnt="<?= implode(',', $arrTemp_t) ?>"
                                                                    data-idseccion="<?= $seccion['id'] ?>" 
                                                                    class="btn btn-sm btn-primary editSection" 
                                                                    data-toggle="tooltip" 
                                                                    data-placement="top" 
                                                                    data-iddocente="10" 
                                                                    title="" 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8">
                                                                ...
                                                                <!--grados T-->
                                                                <?php if($tempGrados_T != '') { 
                                                                    $mt4 = $tempGrados_M == '' ? 'mt-4' : '';    
                                                                ?>
                                                                    <div class="row <?= $mt4 ?>" style="background: linear-gradient(141deg, rgba(233, 24, 46, 1) 0%, rgba(224, 70, 86, 1) 18%, rgba(255, 174, 51, 1) 46%, rgba(255, 196, 51, 0.9641106442577031) 66%, rgba(255, 225, 51, 0.8352591036414566) 87%); padding: 3px; border-radius: 30px">
                                    ...
                                    <?php } else { ?>
                                        <div class="col-12">
                                            <div class="card" style="height: 100px;">
                                                <center><p style="margin-top: 35px;"><b>No se encontraron Secciones Registradas</b></p></center>
                                            </div>
                                        </div>
                                    <?php } ?>
